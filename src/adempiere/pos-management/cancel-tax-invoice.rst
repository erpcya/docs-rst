...
.. |opción procesar pago de la ventana caja| image:: resources/option-process-checkout-window-payment.png
...
.. |opción procesar orden del icono proceso de la ventana órdenes de venta| image:: resources/option-process-order-icon-window-process-sales-orders.png
