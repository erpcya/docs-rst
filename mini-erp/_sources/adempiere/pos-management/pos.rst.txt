...
.. |acercar asignación entre factura y cobro| image:: resources/bring-allocation-between-invoice-and-collection.png
.. |pestaña asignaciones y campo pago| image:: resources/assignments-tab-and-payment-field.png
...
.. _documento/proceso-para-cobrar-pedido:
...
Luego de haber cargado todos los productos de la venta en la orden, debe seleccionar el icono "**Pago**" para generar el cobro de los mismos.
    ...
    Adicional a ello, se muestra los siguientes campos:
        ...
        .. note::
            ...
            Suponiendo que el día "**10/02/2021**", se tiene la orden de venta "**OPOS-846**" con monto total a pagar de "**75.917.563,54**" y el cliente decide cancelar con dólares en efectivo, los siguientes datos serían:

            - **Cobro en Dólares en Efectivo:**
...
Una vez ubicada la factura, seleccione el icono "**Visualiza Detalle (Donde es Usado)**" y finalmente haga clic sobre la opción "**Consulta de Asignación**", para acercar la asignación entre la factura y el cobro de la factura.

    |acercar asignación entre factura y cobro|

    Imagen 28. Acercar Asignación desde Factura por Cobrar

Una vez en la ventana "**Consulta de Asignación**", seleccione la pestaña "**Asignaciones**" y copie el número de documento del cobro que se encuentra en el campo "**Pago**".

    |pestaña asignaciones y campo pago|

    Imagen 29. Pestaña Asignaciones y Campo Pago
