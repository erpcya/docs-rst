...
- LVE: Corrección de parámetro malo en búsqueda de método de pago
...
- Corrección de parámetro malo en búsqueda de método de pago al momento de generar retenciones desde órdenes de ventas de Punto de Ventas
