.. _documento/acumulado-salario-normal:

.. |Acumulado Salario Normal| image:: resources/detalleanticipovacaciones11.png

============================
**Acumulado Salario Normal**
============================

El Acumulado del Salario Normal para Vacaciones se refiere al monto qué acumulo el trabajador durante los 3 meses anteriores que estipula la ley y fue procesado en la nómina regular, dicho valor será fundamental para obtener el promedio salario de vacaciones 
...
#. **Proceso de Nómina**: Puede seleccionar el proceso de nómina regular en la que desee conocer cuál fue el monto obtenido por concepto acumulado salario normal.
...
#. "**Resumen de Pago**": Está plantilla de reporte de nómina nos permitirá conocer de manera resumida el monto del concepto acumulado salario normal omitiendo algunos detalle que usted puede encontrar en los demás procesos de nóminas. Esta plantilla presentará por cada uno de los concepto un monto total por cada empleado:
   ...
   |                                               | por el concepto acumulado salario normal      |
   +-----------------------------------------------+-----------------------------------------------+
   |  Total                                        | Corresponde al monto total obtenido por       |
   |                                               | concepto                                      |
   +-----------------------------------------------+-----------------------------------------------+

En el siguiente ejemplo se presenta  el monto del concepto acumulado salario normal  por el empleado durante el proceso de una nómina regular determinada.
