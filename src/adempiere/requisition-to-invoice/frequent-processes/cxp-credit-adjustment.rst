.. _documento/ajuste-de-crédito-de-cxp:

**Ajuste de Crédito de CxP**
============================
...
El siguiente documento tiene como objeto conocer el procedimiento para el registro de los "**Ajustes de Crédito de Cuentas por Pagar**" en ADempiere, ya sea para anular "**Ajustes de Débito de Cuentas por Pagar**" o para disminuir el saldo de un proveedor por una cuenta por pagar.

Este procedimiento se realiza desde la ventana "**Documentos por Pagar**". Para accededr a la misma, se debe ubicar en el menú de ADempiere y seleccionar la carpeta "**Gestión de Compras**", para luego seleccionar la ventana "**Documentos por Pagar**", indicada anteriormente.
...
- Organización: Debe seleccionar la organización tildada al momento de ingresar en ADempiere.
...
- N° de Documento: Se asignará automáticamente una vez se guarde el registro, este tiene dos comportamientos:
    ...
    - Cuando se crea el documento y este se encuentre en estado "**Borrador**", el número de documento tendrá una secuencia temporal arrojada por ADempiere.
...
- N° de Control: El valor de este campo dependerá decomo se lleve el control de este documento en la organización.
...
- Fecha de Facturación: Seleccione la fecha en la cual se esta emitiendo el "**Ajustes de Crédito de Cuentas por Pagar**"
...
- Socio de Negocio: Indique el cliente al cual se le aplicará el "**Ajustes de Crédito de Cuentas por Pagar**"

- Tipo de documento: La selección de este campo define el comportamiento del documento a registrar, en este caso se utiliza el tipo de documento "**Ajustes de Crédito de Cuentas por Pagar**"

- Dirección del Socio del Negocio: En este campo se selecciona la dirección que tenga asociada al proveedor y que se requiera reflejar en el documento a crear

- Usuario: En este campo se puede asociar un contacto que posea el usuario y que quiera reflejar como un contacto en el documento a crear
...
- Moneda: El valor de este campo dependerá de la lista de precio a asociar al "**Ajustes de Crédito de Cuentas por Pagar**"
...
.. note::
    ...
    Para más información sobre dichos campos, puede consultar el material :ref:`documento/documento-por-pagar`.
...
Una vez hecho el llenado de los campos correspondiente al escenario que se les presente, se procede a asociar el detalle del "**Ajustes de Crédito de Cuentas por Pagar**, Para ello, se deben seleccionar en la pestaña "**Línea de la Factura**" y asociar los siguientes daros, dependiendo del detalle:
...
- Si el detalle es contra un producto, se debe hacer el llenado de los siguientes datos:
    ...
    - Impuesto: Este campo indica que el producto tiene un valor de impuesto para la ser facturado, esta valor lo debe tomar automáticamente si el producto fue configurado en la ventana "**Producto**" con el valor de impuesto "**Impuesto de Venta**" de lo contrario puede configurarse o dependiendo del escenario puede ser cambiado a exento o colocar el valor de impuesto que se maneje en la actualidad.
...
- Si el detalle es contra un servicio, se debe hacer el llenado de lo siguientes datos:
    ...
    - Cargo: Los servicios en ADempiere son llamados cargos, bajo este campo se asocia el servicio a reflejar en el "**Ajustes de Crédito de Cuentas por Pagar**". ADempiere cuenta con una amplia lista de servicios cargados, como por ejemplo: "**Diferencia en Precio de Compras**", "**Servicio de Limpieza y Mantenimiento**" , entre otros.
...
En el campo "**Total de Líneas**", se puede visualizar monto total del documento sin impuestos. El mismo se calcula de manera automática con la sumatoria del valor con contiene el campo "**Neto de Línea**", de todas las líneas que contiene el documento en la pestaña "**Línea de la Factura**" del "**Ajustes de Crédito de Cuentas por Pagar**".

De igual manera, se puede visualizar en el campo "**Gran Totral**", el monto total del documento incluyendo impuestos. El mismo se calcula de manera automática con la sumatoria del valor del campo "**Total de Líneas**" más los impuestos que contengan las líneas del documento en la pestaña "**Línea de la Factura**" del "**Ajustes de Crédito de Cuentas por Pagar**".
...
En el campo "**Estado del Documento**", se indica el estado en el que se encuentra el documento "**Ajustes de Crédito de Cuentas por Pagar**"; los estados son los siguientes:

    - Borrador: Este estado es para aquellos documentos que han sido creados pero aun se esta modificando alguna información o dato a asociar al "**Ajustes de Crédito de Cuentas por Pagar**", este tipo de documento para ADempiere está en espera de ser un documento válido o "**Completo**".
