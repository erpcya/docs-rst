...
.. |campo crear desde tipo factura de la ventana crear recibo de orden de compra o rma| image:: resources/field-create-from-invoice-type-of-the-window-create-receipt-of-purchase-order-or-rma.png
.. |campo factura de la ventana crear recibo de orden de compra o rma| image:: resources/invoice-field-of-the-create-purchase-order-receipt-or-signature-window.png
.. |opcion comenzar busqueda de factura de la ventana crear recibo de orden de compra o rma| image:: resources/option-start-invoice-search-from-the-window-create-receipt-of-purchase-order-or-rma.png
.. |seleccion de factura de la ventana crear recibo de orden de compra o rma| image:: resources/invoice-selection-from-the-create-purchase-order-receipt-or-signature-window.png
.. |ubicacion de recibo de factura de la ventana crear recibo de orden de compra o rma| image:: resources/window-invoice-receipt-location-create-purchase-order-receipt-or-rma.png
.. |icono refrescar de la ventana recepción de productos| image:: resources/refresh-window-icon-product-reception.png
.. |campo orden de compra de la ventana recepción de productos desde factura| image:: resources/purchase-order-field-of-the-window-receipt-of-products-from-invoice.png
.. |campo tipo de movimiento de la ventana recepción de productos desde factura| image:: resources/field-type-of-movement-of-the-window-receipt-of-products-from-invoice.png
.. |pestaña línea del recibo de la ventana recepción de productos desde factura| image:: resources/receipt-line-tab-of-the-window-receipt-of-products-from-invoice.png
.. |opción procesar recepción en el icono proceso desde factura| image:: resources/option-process-receipt-in-the-icon-process-from-invoice.png
.. |Opción Completar| image:: resources/option-complete.png

.. _documento/recepción-desde-factura:

**Registro de Recepción Desde Factura**
=======================================
...
#. Seleccione la opción "**Crear Desde Pedido/RMA**", generada al seleccionar el icono "**Proceso**", ubicado en la barra de herramientas de ADempiere.
    ...
    #. Seleccione en el campo "**Crear Desde Tipo**", la opción "**Factura**" para crear la recepción desde la factura.
        ...
        |campo crear desde tipo factura de la ventana crear recibo de orden de compra o rma|
    ...
    #. Seleccione en el campo "**Factura**", la factura desde la cual se va a generar el documento de recepción.
        ...
        |campo factura de la ventana crear recibo de orden de compra o rma|
    ...
    #. Seleccione la opción "**Comenzar Búsqueda**", para filtrar la información en base a lo seleccionado en los campos anteriormente explicados.
        ...
        |opcion comenzar busqueda de factura de la ventana crear recibo de orden de compra o rma|

        Imagen 20. Opción Comenzar Búsqueda

    #. Seleccione la factura desde la cual requiere generar el documento de recepción.

        |seleccion de factura de la ventana crear recibo de orden de compra o rma|
    ...
    #. Seleccione en el campo "**Recibo todo en la Ubicación Entrante**", la ubicación en la cual se almacenará lo recepcionado. Luego seleccione la opción "**OK**" para cargar a la ventana "**Recepción de Productos**" la información de la factura seleccionada.
        ...
        |ubicacion de recibo de factura de la ventana crear recibo de orden de compra o rma|
...
#. En el campo "**Orden de Compra**", se muestra la orden de compra relacionada a recepción de los productos. Para este ejemplo, como es creada la recepción desde la factura y esta no posee orden de compra asociada, el campo queda sin ningún valor.
    ...
    |campo orden de compra de la ventana recepción de productos desde factura|
...
#. Podrá visualizar en el campo "**Tipo de Movimiento**", el método de movimiento de inventario correspondiente a la recepción de los productos.
    ...
    |campo tipo de movimiento de la ventana recepción de productos desde factura|
...
#. Para revisar y confirmar la información cargada desde la factura, seleccione la pestaña "**Línea del Recibo**".
    ...
    |pestaña línea del recibo de la ventana recepción de productos desde factura|
...
#. Regrese a la pestaña principal "**Recibo de Material**"  y seleccione la opción "**Procesar Orden**", desplegada por el icono "**Proceso**", ubicado en la barra de herramientas de ADempiere.
    ...
    |opción procesar recepción en el icono proceso desde factura|
